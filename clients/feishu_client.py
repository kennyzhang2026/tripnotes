...
class FeishuClient:
    ...
    def get_user(self, username: str) -> Optional[dict]:
        ...
        params = {
            "filter": '{"conditions":[{"field_name":"username","operator":"is","value":[%s]}]}' % json.dumps(username)
        }
    ...
    def get_trip_note(self, note_id: str) -> Optional[dict]:
        ...
        params = {
            "filter": '{"conditions":[{"field_name":"note_id","operator":"is","value":[%s]}]}' % json.dumps(note_id)
        }
